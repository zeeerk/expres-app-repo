...
CHEF_SERVER_NAME="adeel-chef-automate-server" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="adeel-chef-automate-server-rd6xvrd8i5milcxh.us-east-2.opsworks-cm.io" # The FQDN of your Chef Server
